...
function printCVReallyShort() {
  ...
  w.document.write(document.getElementById('cv').innerHTML.replaceAll('<details', '<details hidden = "true" ').replaceAll('<div class="ReallySimple" hidden="true">', '<div class="ReallySimple">'));
  w.document.write('</main></body></html>');
  w.document.close(); // necessary for IE >= 10
  w.focus(); // necessary for IE >= 10
  w.onload = () => {
